  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <Link href="/appointments" className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
        ...
        <Link href="/billing" className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
          <div className="flex items-center">
        ...
        <Link href="/invoices" className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
          <div className="flex items-center">
            <DocumentTextIcon className="h-8 w-8 text-purple-500 mr-4" />
            <div>
              <p className="text-gray-500">Facturas</p>
              <p className="text-2xl font-bold">Ver Lista</p>
            </div>
          </div>
        </Link>

        <Link href="/inventory" className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
          <div className="flex items-center">
            <CubeIcon className="h-8 w-8 text-indigo-500 mr-4" />
            <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <Link href="/universal-form" className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
          <div className="flex items-center">
            <ClipboardDocumentListIcon className="h-8 w-8 text-orange-500 mr-4" />
            <div>
              <p className="text-gray-500">Formulario Universal</p>
              <p className="text-2xl font-bold">Nuevo Formulario</p>
            </div>
          </div>
        </Link>
        ...
        <Link href="/finance" className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-gray-500">Gestión Financiera</p>
              <p className="text-2xl font-bold">Ver Análisis</p>
            </div>
          </div>
        </Link>
      </div>
